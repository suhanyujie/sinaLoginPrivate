...
class GetWeiboCookie
{
	...
	{
		$this->configPath = $configPath ? $configPath : Main::$configPathStatic;
		//加载微博登录配置
		$this->config = require(dirname(__FILE__).'/GetWeiboCookieConfig.php');
		//如果配置文件不存在，取系统配置
		if(!$this->getConfig()){
	 ...
	 * dw_microtime函数来自于 helpers.php文件中
	 */
